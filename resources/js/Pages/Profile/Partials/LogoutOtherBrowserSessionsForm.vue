                ...
                <div v-if="sessions.length > 0" class="mt-5 space-y-6">
                    <v-list lines="two">
                        <v-list-item v-for="(session, i) in sessions" :key="i"
                                     class="d-flex align-center mb-2 items-center">
                            <template v-slot:prepend>
                                <svg v-if="session.agent.is_desktop" class="w-8 h-8 text-gray"
                                ...
                                <svg v-else class="w-8 h-8 text-gray" fill="none" stroke="currentColor"
